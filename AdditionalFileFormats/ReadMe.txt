========================================================================
    DYNAMIC LINK LIBRARY: STLimportexport-Projektübersicht
========================================================================

Diese STLimportexport-DLL wurde vom Anwendungs-Assistenten für Sie erstellt.

Diese Datei bietet eine Übersicht über den Inhalt der einzelnen Dateien, aus
denen Ihre STLimportexport-Anwendung besteht.


STLimportexport.vcxproj
...
STLimportexport.vcxproj.filters
...
StdAfx.h, StdAfx.cpp
    Mit diesen Dateien werden eine vorkompilierte Headerdatei (PCH) mit dem Namen STLimportexport.pch und eine vorkompilierte Typendatei mit dem Namen StdAfx.obj erstellt.
